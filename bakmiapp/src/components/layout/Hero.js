			...
			<section className="hero mt-8">
				<div className="py-12">
					...
					<div className="flex gap-4">
						<button className="flex justify-center gap-2 bg-primary text-white uppercase font-semibold items-center px-4 py-2 rounded-full hover:bg-blue-500 transition-all">
							Order Now <Right />
						</button>
